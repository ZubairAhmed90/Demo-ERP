...
import { FaClipboardList, FaPlus, FaSearch, FaEdit, FaEye, FaCheck, FaCalendar } from 'react-icons/fa';
import { useColor } from '../../../context/ColorContext.jsx';
import Layout from '../../../components/Layout/Layout.jsx';
import Pagination from '../../../components/pagination/Pagination.jsx';

const workOrders = [
  { id: 1, workOrderNumber: 'WO-2024-001', productionOrder: 'PO-2024-001', task: 'Assembly', assignedTo: 'Team A', startDate: '2024-01-20', endDate: '2024-01-22', status: 'In Progress', priority: 'High' },
  { id: 2, workOrderNumber: 'WO-2024-002', productionOrder: 'PO-2024-001', task: 'Quality Check', assignedTo: 'Team B', startDate: '2024-01-23', endDate: '2024-01-24', status: 'Planned', priority: 'Medium' },
  { id: 3, workOrderNumber: 'WO-2024-003', productionOrder: 'PO-2024-002', task: 'Packaging', assignedTo: 'Team C', startDate: '2024-01-21', endDate: '2024-01-22', status: 'Completed', priority: 'Low' },
];
...
const Page = () => {
  ...
  const filteredOrders = workOrders.filter((order) => {
    const matchesSearch = 
      ...
      order.task.toLowerCase().includes(searchQuery.toLowerCase());
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Manage manufacturing work orders and tasks</p>
              </div>
            </div>
            <button
              onClick={() => navigate('/manufacturing/create-work-order')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">{workOrders.length}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              ...
              <FaClipboardList className="w-8 h-8 text-yellow-500" />
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {workOrders.filter(w => w.status === 'Planned').length}
                </p>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search by work order number or task..."
                value={searchQuery}
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100">
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase">Work Order #</th>
                ...
                {paginatedOrders.map((order) => (
                  <tr key={order.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="text-sm font-medium text-gray-900">{order.workOrderNumber}</span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{order.productionOrder}</td>
                    <td className="px-6 py-4 text-sm text-gray-900">{order.task}</td>
