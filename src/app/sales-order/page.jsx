...
const Page = () => {
  ...
  const calculateTotals = (items = orderItems) => {
    ...
    const freight = salesOrder.freight || 0;
    const rounding = salesOrder.rounding || 0;
  ...
  const handleSubmit = (action) => {
    if (salesOrder.customer && orderItems.some(item => item.description && item.quantity > 0)) {
      // Here you would typically make an API call to save the sales order
      console.log('Saving sales order:', { salesOrder, orderItems });
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">View and manage existing sales orders</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                                 <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={salesOrder.contactPerson}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={salesOrder.customerRefNo}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={salesOrder.salesEmployee}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">${salesOrder.totalAmount.toFixed(2)}</span>
                </div>
                ...
                <div className="flex justify-between text-lg font-bold">
                  ...
                  <span>${salesOrder.grandTotal.toFixed(2)}</span>
                </div>
              </div>
            </div>
