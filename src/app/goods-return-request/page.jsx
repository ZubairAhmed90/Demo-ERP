...
const Page = () => {
  ...
  const [goodsReturnRequest, setGoodsReturnRequest] = useState({
    requestNumber: '',
    customer: '',
    customerName: '',
    contactPerson: '',
  ...
  const calculateTotals = (items = orderItems) => {
    ...
    const freight = goodsReturnRequest.freight || 0;
    const tax = goodsReturnRequest.tax || 0;
  ...
  const handleAddItem = () => {
    ...
    addToast('New item added to return request', 'success');
  };
  ...
  const handleRemoveItem = (index) => {
    if (orderItems.length > 1) {
      ...
      setOrderItems(newItems);
      calculateTotals(newItems);
      addToast('Item removed from return request', 'info');
    } else {
  ...
  const handleSubmit = (action) => {
    if (goodsReturnRequest.customer && orderItems.some(item => item.description && item.quantity > 0)) {
      // Here you would typically make an API call to save the goods return request
      console.log('Saving goods return request:', { goodsReturnRequest, orderItems });
      
      if (action === 'addAndClose') {
        addToast('Goods return request created successfully!', 'success');
        setTimeout(() => {
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-800">Goods Return Requests</h1>
                  <p className="text-gray-600">View and manage existing goods return requests</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <button
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex flex-col lg:flex-row gap-4">
              <div className="flex-1 relative">
                <input
                  type="text"
                  placeholder="Search requests by number, customer, or status..."
                ...
                <tbody className="divide-y divide-gray-100">
                  {existingRequests.map((request, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          <span className="text-sm font-medium text-gray-900">{request.customer}</span>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-gray-900">{request.returnReason}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Goods Return Request</h1>
                <p className="text-gray-600">Create and manage goods return requests</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={goodsReturnRequest.customer}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={goodsReturnRequest.customerName}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={goodsReturnRequest.contactPerson}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={goodsReturnRequest.customerRefNo}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={goodsReturnRequest.requestNumber}
              ...
              <div>
                ...
                <select
                  value={goodsReturnRequest.status}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="date"
                    value={goodsReturnRequest.postingDate}
                ...
                <div>
                  ...
                  <input
                    type="date"
                    value={goodsReturnRequest.documentDate}
              ...
              <div>
                ...
                <select
                  value={goodsReturnRequest.returnReason}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={goodsReturnRequest.salesEmployee}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={goodsReturnRequest.owner}
              ...
              <div>
                ...
                <textarea
                  value={goodsReturnRequest.remarks}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">${goodsReturnRequest.totalAmount.toFixed(2)}</span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <input
                    type="number"
                    value={goodsReturnRequest.freight}
                ...
                <div className="flex justify-between text-lg font-bold">
                  ...
                  <span>${goodsReturnRequest.grandTotal.toFixed(2)}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => navigate('/goods-return-request')}
