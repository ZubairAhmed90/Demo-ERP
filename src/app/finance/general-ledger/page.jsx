...
import { FaBook, FaSearch, FaPlus, FaEdit, FaCalendar, FaFilter } from 'react-icons/fa';
import { useColor } from '../../../context/ColorContext.jsx';
import Layout from '../../../components/Layout/Layout.jsx';
import Pagination from '../../../components/pagination/Pagination.jsx';

const journalEntries = [
  { id: 1, entryNumber: 'JE-001', date: '2024-01-15', description: 'Sales Revenue Entry', debit: 10000, credit: 10000, status: 'Posted', postedBy: 'Admin' },
  { id: 2, entryNumber: 'JE-002', date: '2024-01-14', description: 'Purchase Expense Entry', debit: 5000, credit: 5000, status: 'Posted', postedBy: 'Admin' },
  { id: 3, entryNumber: 'JE-003', date: '2024-01-13', description: 'Salary Payment Entry', debit: 15000, credit: 15000, status: 'Draft', postedBy: '-' },
  { id: 4, entryNumber: 'JE-004', date: '2024-01-12', description: 'Depreciation Entry', debit: 2000, credit: 2000, status: 'Posted', postedBy: 'Admin' },
];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="p-3 rounded-xl" style={{ backgroundColor: `${primaryColor}15` }}>
                <FaBook className="w-6 h-6" style={{ color: primaryColor }} />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-gray-800">General Ledger</h1>
                <p className="text-gray-600">View and manage journal entries and ledger transactions</p>
              </div>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              ...
              <FaBook className="w-8 h-8 text-gray-500" />
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">
                  {journalEntries.reduce((sum, e) => sum + e.debit, 0).toLocaleString()} SAR
                </p>
              </div>
              <FaBook className="w-8 h-8 text-gray-500" />
            </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase">Debit</th>
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase">Credit</th>
                ...
                {paginatedEntries.map((entry) => (
                  <tr key={entry.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                      {entry.debit.toLocaleString()} SAR
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                      {entry.credit.toLocaleString()} SAR
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{entry.postedBy}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
